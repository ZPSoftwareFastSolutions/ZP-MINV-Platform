...
ICONS: dict[str, list] = {
    ...
    # V1.2
    "buscar": [("circle", 10.5, 10.5, 6.5), ("line", 15.4, 15.4, 20.5, 20.5)],
    "pedido": [
        ("poly", [(2.5, 4), (5.2, 4), (7.6, 15), (18.4, 15), (20.6, 7.6), (6.1, 7.6)], False),
        ("circle", 9.2, 19.3, 1.5), ("circle", 16.9, 19.3, 1.5),
    ],
    "conteo": [
        ("poly", [(6, 4.8), (18, 4.8), (18, 21), (6, 21)], True),
        ("poly", [(9.2, 3), (14.8, 3), (14.8, 6.4), (9.2, 6.4)], True),
        ("poly", [(9, 13.6), (11.3, 15.9), (15.3, 11.3)], False),
    ],
    "proveedores": [
        ("poly", [(2.5, 6), (14, 6), (14, 16), (2.5, 16)], True),
        ("poly", [(14, 9.5), (18.4, 9.5), (21.5, 12.6), (21.5, 16), (14, 16)], False),
        ("circle", 7, 17.6, 1.9), ("circle", 17.4, 17.6, 1.9),
    ],
    "bitacora": [
        ("poly", [(5, 3), (19, 3), (19, 21), (5, 21)], True),
        ("line", 8.5, 8, 15.5, 8), ("line", 8.5, 12, 15.5, 12), ("line", 8.5, 16, 12.5, 16),
    ],
}
