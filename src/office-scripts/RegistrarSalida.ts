 ...
 *   1. Identifica la cuenta de Microsoft 365 y la autoriza contra 02_USUARIOS (roles VENTAS o ADMIN).
 *   2. Valida la fila (producto activo, cantidad, decimales, fecha) sin confiar en las fórmulas.
 *   3. Poka-yoke: si la salida supera el disponible exacto (suma de las dos bitácoras), BLOQUEA la consolidación.
 *      La fila ya se ve en rojo sangre con texto blanco tachado por el formato condicional.
 *   4. Agrega la salida al final de la bitácora (inserción atómica) con ID, Usuario_O365 y Timestamp y vuelve a
...
function main(workbook: ExcelScript.Workbook): string {
  return registrar(workbook, "VENTAS", "10B_SALIDAS", "tblCapturaSalidas", "tblSalidas", "S",
    ["VENTAS", "ADMIN"], ["Fecha", "Producto", "Cantidad", "Documento", "Observaciones"]);
}
